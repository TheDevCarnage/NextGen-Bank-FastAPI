...
Revision ID: cd8d3b78a434
Revises:
Create Date: 2025-11-10 06:50:58.308038
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "account_status",
            sa.Enum(
                "ACTIVE", "INACTIVE", "PENDING", "LOCKED", name="accountstatusschema"
            ),
            nullable=False,
        ),
        sa.Column(
